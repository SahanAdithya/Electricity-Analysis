...
import { Trash2, Edit2, CheckCircle, Clock, Wallet, TrendingUp, PieChart as PieIcon, ArrowUpRight, CreditCard, Bell, AlertCircle, Calendar, Sparkles, RefreshCw, X } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fafafa] text-black pb-20 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-100 rounded-xl text-xs font-bold uppercase tracking-widest hover:shadow-md transition-all disabled:opacity-50 text-purple-700"
            >
              <Sparkles size={14} className={gettingInsight ? 'animate-pulse' : ''} />
              {gettingInsight ? 'Analyzing...' : 'AI Insights'}
            </button>
            <button 
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 space-y-8">
        {/* AI Insight Banner */}
        {aiInsight && (
          <div className="bg-black text-white p-6 rounded-[32px] relative animate-in slide-in-from-top-4 duration-500 shadow-2xl shadow-black/20">
            <button 
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-widest text-purple-400 mb-1">AI Smart Advisor</h4>
                <p className="text-sm leading-relaxed font-medium opacity-90">{aiInsight}</p>
              </div>
            </div>
          </div>
        )}
