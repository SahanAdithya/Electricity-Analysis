    ...
    <div className="min-h-screen bg-black text-white selection:bg-accent selection:text-background">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <SignInButton mode="modal">
              <button className="px-6 py-2.5 bg-green-500 text-black rounded-xl text-xs font-black uppercase tracking-widest hover:bg-white transition-all shadow-lg shadow-green-500/20">
                Sign In
              </button>
            </SignInButton>
          </div>
      ...
      <section className="relative pt-40 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-8">
            <SignInButton mode="modal">
              <button className="group px-12 py-6 bg-white text-black rounded-3xl font-black uppercase tracking-widest hover:bg-green-500 hover:text-white transition-all flex items-center gap-3 shadow-2xl shadow-white/5">
      ...
      <section className="py-40 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 space-y-12">
          ...
          <SignInButton mode="modal">
            <button className="px-12 py-6 bg-white text-black rounded-3xl font-black uppercase tracking-widest hover:bg-green-500 hover:text-white transition-all shadow-[0_0_50px_rgba(255,255,255,0.1)] hover:shadow-green-500/20">
              Create Free Account
            </button>
          </SignInButton>
...
function FeatureCard({ icon, title, desc }: { icon: any, title: string, desc: string }) {
  return (
    <div className="p-10 rounded-[40px] border border-white/10 bg-zinc-900/50 hover:bg-zinc-800 transition-all group">
      <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-8 text-green-500 group-hover:scale-110 transition-transform border border-white/5">
        {icon}
      </div>
      <h3 className="text-2xl font-black mb-4 uppercase tracking-tight text-white">{title}</h3>
      <p className="text-zinc-300 text-sm leading-relaxed font-medium">{desc}</p>
    </div>
  )
}
